    ...
    public function store(Request $request)
    {
        try {
            ...
            $validatedData = $request->validate([
                'customer_name' => 'required|string',  // Changed to required
                'seller_name' => 'required|string',    // Changed to required
                'order_details' => 'required|string',  // Changed to required
                'deposit' => 'nullable|numeric',
                'rest_of_cost' => 'nullable|numeric',
                'customer_phone' => 'nullable|string|max:11',  // Changed to required
                'order_date' => 'required|date',       // Changed to required
                'deliver_date' => 'nullable|date',
                'status' => 'nullable|string',
                'payment_method' => 'nullable|string',
                
                'order_kind' => 'required|array',      // Changed to required|array
                'order_kind.*' => 'required|string',   // Changed to required
                'order_fix_type' => 'required|array',  // Changed to required|array
                'order_fix_type.*' => 'required|string', // Changed to required
