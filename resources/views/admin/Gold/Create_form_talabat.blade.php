...
<head>
    ...
    <title>Create Talabat Item</title>
...
<body>
    ...
    <div class="parent">
        <form class="create-form" action="{{ route('gold-items_T.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit">Create Talabat Item</button>
        </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchItems(modelValue) {
                ...
                fetch(`/talabat/model-details?model=${encodeURIComponent(modelValue)}`, {
                        method: 'GET',
                        headers: {
                    ...
                    .then(data => {
                        ...
                        if (data.talabatDetails && data.talabatDetails.scanned_image) {
                            const imageElement = document.createElement('img');
                            imageElement.src = `/storage/${data.talabatDetails.scanned_image}`;
                            imageElement.alt = `Model ${data.talabatDetails.model}`;
