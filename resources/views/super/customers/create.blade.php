...
<head>
    ...
    <title>Add New Customer - Super User</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="col-lg-8">
                <div class="card customer-form-card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title mb-0"><i class="bx bx-user-plus me-2"></i>Customer Information</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('super.customers.store') }}">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('super.customers') }}" class="btn btn-secondary">
                                    <i class="bx bx-arrow-back me-2"></i>Back to Customers
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    <i class="bx bx-save me-2"></i>Create Customer
                                </button>
                            </div>
                        </form>
                    </div>
