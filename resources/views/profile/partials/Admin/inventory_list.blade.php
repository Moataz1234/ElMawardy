                                ...
                                <td>
                                    <div class="actions-container">
                                        <div style="position: relative;">
                                            <input type="checkbox" name="selected_items[]" value="{{ $item->id }}" {{ $item->status == 'pending_kasr' ? 'disabled' : '' }}/>
            ...
            function displayItemsForCurrentPage() {
                ...
                document.querySelectorAll('.model-item-checkbox').forEach(checkbox => {
                    checkbox.addEventListener('change', function() {
                        ...
                        console.log('Updated selected items:', Array.from(selectedItemIds.values()));
                    });
                });
                ...
                selectAllCheckbox.addEventListener('change', function() {
                    ...
                    console.log('Updated selected items after select all:', Array.from(selectedItemIds.values()));
                });
            }
                    ...
                    Swal.fire({
                        ...
                        if (transferAllModels) {
                            ...
                            const promises = models.map(model => 
                                fetch(`/gold-items/same-model?model=${encodeURIComponent(model)}`)
                            ...
                            Promise.all(promises)
                                .then(results => {
                                    ...
                                    results.forEach(data => {
                                        if (data.items && data.items.length) {
                                            ...
                                            console.log('Raw data received for model:', data.items[0].model, data.items);
                                ...
                                .catch(error => {
                                    ...
                                    document.getElementById('model-selection-content').innerHTML = 
