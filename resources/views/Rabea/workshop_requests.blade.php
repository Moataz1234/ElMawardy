...
<head>
    ...
    <title>Rabea Workshop Requests</title>
...
<body>
    ...
    <div class="container">
        <h1 class="text-center mb-4">Rabea Workshop Transfer Requests</h1>
        ...
        <div class="filters-container">
            <form action="{{ route('rabea.workshop.requests') }}" method="GET" class="row align-items-end">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <a href="{{ route('rabea.workshop.requests') }}" class="btn btn-secondary btn-block mt-2">Reset</a>
                </div>
            </form>
        </div>

        <form action="{{ route('rabea.workshop.requests.handle') }}" method="POST" id="batchActionForm">
            @csrf
                    ...
                    <tbody>
                        ...
                        @forelse ($requests ?? [] as $request)
                            ...
                            <tr>
                                ...
                                <td>{{ $goldItem ? $goldItem->shop_name : 'N/A' }}</td>
                                <td>{{ $itemModel }}</td>
                                <td>{{ $itemWeight }} g</td>
                            ...
                            <tr>
                                <td colspan="9" class="text-center">
                                    <div class="alert alert-info">
                                        <p>No workshop requests found for Rabea shop.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
